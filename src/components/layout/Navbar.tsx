      ...
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <svg
            ...
            className="h-8 w-auto text-yellow-400 animate-fadeIn"
            fill="currentColor"
          >
            <g>
